  ...
  <main>
    <div class="row g-5 py-5 ">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form action="api/v1/cities/city.php" method="post" class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
          ...
          <button class="mt-3 w-30 btn btn-primary btn-md" type="submit">Continue to checkout</button>
        </form>
      </div>
    </div>
  </main>
